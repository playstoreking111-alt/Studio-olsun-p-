    ...
    return function(props)
        ...
        for property, value in pairs(props) do
            if property ~= "Parent" then
                -- pcall kullanarak artık var olmayan (deprecated) özelliklerin 
                -- scripti durdurmasını engelliyoruz.
                pcall(function()
                    inst[property] = value
                end)
            end
        ...
        -- Performans için Parent atamasını en son yapıyoruz
...
-- ÖNEMLİ: Eğer aşağıdakiler varsa bunları SİLmelisin:
-- local RbxUtility = LoadLibrary("RbxUtility") <-- Bunu sil
-- local Create = RbxUtility.Create             <-- Bunu sil


writefile("Nahid.mp3", game:HttpGet("https://github.com/playstoreking111-alt/Studio-olsun-p-/raw/refs/heads/main/Roblox%20Revenant%20OST%20-%20ALL%20SEEING%20(Eyo-zen%20chase).mp3"))
