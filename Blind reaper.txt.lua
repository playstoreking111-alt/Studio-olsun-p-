...
local plr = game.Players.LocalPlayer if plr.Character then plr.Character.Name = "MaxDesignPro" end repeat wait() until game.Workspace:FindFirstChild("MaxDesignPro")
