...
mouse.KeyDown:connect(function(k)
	...
	if k == "4" and attack == false then
		lighting.TimeOfDay = 3
		hum.WalkSpeed = 15
		Speed = 40
		kan.Pitch = 0.92
		kan.SoundId = "rbxassetid://4456467079"
		BanishMode = "Ciomna"
		Titlething.Text = "Ciomna"
		vis.Material = "Neon"
		vis.BrickColor = BrickColor.new(Color3.fromRGB(115, 57, 173))
		Titlething.TextColor3 = Color3.fromRGB(141, 70, 211)
	...
	if k == "m" and BanishMode == "deeri" and attack == false then
		...
		Titlething.TextColor3 = Color3.fromRGB(255, 85, 255)
	...
	if k == "5" and attack == false then
		...
		Speed = 40
		kan.Pitch = 0.92
		kan.SoundId = "rbxassetid://1835940370"
		BanishMode = "chy"
		Titlething.Text = "Chaosed"
		Titlething.TextColor3 = Color3.fromRGB(0, 255, 255)
		vis.BrickColor = BrickColor.new(Color3.fromRGB(0, 255, 255))
	...
	if k == "g" and attack == false then
		...
		kan.Pitch = 0.92
		BanishMode = "cc"
		Titlething.Text = "Christmas Chill"
		Titlething.TextColor3 = Color3.fromRGB(181, 27, 0)
		kan.TimePosition = 0
		vis.BrickColor = BrickColor.new(Color3.fromRGB(181, 0, 0))
		function gsongs()
		if g == true then

			kan.SoundId = "rbxassetid://2644338409"
			wait(207)
			if BanishMode == "cc" then

				
				kan.SoundId = "rbxassetid://4495581826"
				wait(87)
				if BanishMode == "cc" then
					
					kan.SoundId = "rbxassetid://598836206"
					wait(164)
					if BanishMode == "cc" then
						
							kan.SoundId = "rbxassetid://2646390015"
							wait(225)
							gsongs()
	...
	if BanishMode == "Ciomna" == false then

		a= game.Lighting
		vis.Material = "Plastic"
		lighting = a
		a.TimeOfDay = 14
	end
	if BanishMode == "cc" == false then
		g = false
		kan.IsPlaying = true
		cc = false
	end
...
while true do
	...
	if RootPart.Velocity.y > 1.25 or RootPart.Velocity.y < -1.25 and hitfloor==nil then 
		...
		if attack==false and BanishMode == "Ciomna" then
			if equipped == false then
				lighting.TimeOfDay = 3
				local change = .1 
				sine = sine + change 
				RH.C0=clerp(RH.C0,cf(1 + 0 * math.cos(sine / 4),-1 + .25 * math.cos(sine / 4),-.5 + .3 * math.cos(sine / 4))*angles(math.rad(0 + 0 * math.cos(sine / 4)),math.rad(130 + 0 * math.cos(sine / 4)),math.rad(-60 + 0 * math.cos(sine / 4))),.2)
				LH.C0=clerp(LH.C0,cf(-1 + 0 * math.cos(sine / 4),-.7 + .2 * math.cos(sine / 4),-.5 + -.2 * math.cos(sine / 4))*angles(math.rad(-20 + 12 * math.cos(sine / 4)),math.rad(-85 + 0 * math.cos(sine / 4)),math.rad(0 + 0 * math.cos(sine / 4))),.2)
				RootJoint.C0=clerp(RootJoint.C0,RootCF*cf(0 + 0 * math.cos(sine / 4),0 + 0 * math.cos(sine / 4),5 + .2 * math.cos(sine / 4))*angles(math.rad(25 + -14 * math.cos(sine / 4)),math.rad(0 + 0 * math.cos(sine / 4)),math.rad(-20 + 0 * math.cos(sine / 4))),.3)
				Torso.Neck.C0=clerp(Torso.Neck.C0,necko*angles(math.rad(0),math.rad(0),math.rad(0)),.3)
				RW.C0=clerp(RW.C0,cf(1.5 + 0 * math.cos(sine / 4),.2 + 0 * math.cos(sine / 4),0 + 0 * math.cos(sine / 4))*angles(math.rad(-60 + -12 * math.cos(sine / 4)),math.rad(55 + 0 * math.cos(sine / 4)),math.rad(30 + 0 * math.cos(sine / 4))),.3)
				LW.C0=clerp(LW.C0,cf(-1.5 + 0 * math.cos(sine / 4),.7 + 0 * math.cos(sine / 4),0 + 0 * math.cos(sine / 4))*angles(math.rad(90 + -3 * math.cos(sine / 4)),math.rad(-50 + 0 * math.cos(sine / 4)),math.rad(-30 + 0 * math.cos(sine / 4))),.3)
			else
				local change = .1 
				sine = sine + change 
				RH.C0=clerp(RH.C0,cf(1 + 0 * math.cos(sine / 6),-1 + -.5 * math.cos(sine / 6),0 + 0 * math.cos(sine / 6))*angles(math.rad(0 + 0 * math.cos(sine / 6)),math.rad(75 + 0 * math.cos(sine / 6)),math.rad(0 + 5 * math.cos(sine / 6))),.2)
	...
	elseif torvel<1 and hitfloor~=nil then
		...
		if BanishMode == "chy" then
			local change = .1 
			sine = sine + change 
			RH.C0=clerp(RH.C0,cf(1 + 0 * math.cos(sine / 2),-1 + -.1 * math.cos(sine / 2),0 + 0 * math.cos(sine / 2))*angles(math.rad(-45 + 5 * math.cos(sine / 2)),math.rad(80 + 0 * math.cos(sine / 2)),math.rad(35 + 0 * math.cos(sine / 2))),.2)
			LH.C0=clerp(LH.C0,cf(-1 + 0 * math.cos(sine / 2),-1 + -.1 * math.cos(sine / 2),0 + 0 * math.cos(sine / 2))*angles(math.rad(15 + 0 * math.cos(sine / 2)),math.rad(-90 + 0 * math.cos(sine / 2)),math.rad(0 + 0 * math.cos(sine / 2))),.2)
			RootJoint.C0=clerp(RootJoint.C0,RootCF*cf(0 + 0 * math.cos(sine / 2),0 + 0 * math.cos(sine / 2),0 + .1 * math.cos(sine / 2))*angles(math.rad(15 + 0 * math.cos(sine / 2)),math.rad(0 + 0 * math.cos(sine / 2)),math.rad(0 + 0 * math.cos(sine / 2))),.3)
			Torso.Neck.C0=clerp(Torso.Neck.C0,necko*angles(math.rad(0),math.rad(0),math.rad(0)),.3)
			RW.C0=clerp(RW.C0,cf(1.5 + 0 * math.cos(sine / 2),.5 + 0 * math.cos(sine / 2),0 + 0 * math.cos(sine / 2))*angles(math.rad(30 + 5 * math.cos(sine / 2)),math.rad(45 + 0 * math.cos(sine / 2)),math.rad(30 + 0 * math.cos(sine / 2))),.3)
			LW.C0=clerp(LW.C0,cf(-1.5 + 0 * math.cos(sine / 2),.5 + 0 * math.cos(sine / 2),0 + 0 * math.cos(sine / 2))*angles(math.rad(90 + 5 * math.cos(sine / 2)),math.rad(-75 + 5 * math.cos(sine / 2)),math.rad(0 + 0 * math.cos(sine / 2))),.3)
		...
		if BanishMode == "cc" then
			...
			sine = sine + change 
			RH.C0=clerp(RH.C0,cf(1 + 0 * math.cos(sine / 6),-.3 + 0 * math.cos(sine / 6),-.5 + -.02 * math.cos(sine / 6))*angles(math.rad(55 + 1 * math.cos(sine / 6)),math.rad(90 + 0 * math.cos(sine / 6)),math.rad(0 + 0 * math.cos(sine / 6))),.2)
			LH.C0=clerp(LH.C0,cf(-1 + 0 * math.cos(sine / 6),-1.1 + 0 * math.cos(sine / 6),0 + 0 * math.cos(sine / 6))*angles(math.rad(90 + -.02 * math.cos(sine / 6)),math.rad(-80 + 0 * math.cos(sine / 6)),math.rad(0 + 0 * math.cos(sine / 6))),.2)
			RootJoint.C0=clerp(RootJoint.C0,RootCF*cf(0 + 0 * math.cos(sine / 6),0 + 0 * math.cos(sine / 6),-1.5 + .02 * math.cos(sine / 6))*angles(math.rad(0 + 0 * math.cos(sine / 6)),math.rad(0 + 0 * math.cos(sine / 6)),math.rad(0 + 0 * math.cos(sine / 6))),.3)
			Torso.Neck.C0=clerp(Torso.Neck.C0,necko*angles(math.rad(0),math.rad(0),math.rad(0)),.3)
			RW.C0=clerp(RW.C0,cf(1.5 + 0 * math.cos(sine / 6),.5 + 0 * math.cos(sine / 6),0 + 0 * math.cos(sine / 6))*angles(math.rad(120 + 0 * math.cos(sine / 6)),math.rad(70 + 0 * math.cos(sine / 6)),math.rad(-60 + 0 * math.cos(sine / 6))),.3)
			LW.C0=clerp(LW.C0,cf(-1.5 + .01 * math.cos(sine / 6),.505 + .05 * math.cos(sine / 6),0 + 0 * math.cos(sine / 6))*angles(math.rad(0 + 1 * math.cos(sine / 6)),math.rad(-90 + 0 * math.cos(sine / 6)),math.rad(0 + 0 * math.cos(sine / 6))),.3)
		...
		if attack==false and BanishMode == "Ciomna" then
			if equipped == false then
				...
				RH.C0=clerp(RH.C0,cf(1 + 0 * math.cos(sine / 4),-1 + .25 * math.cos(sine / 4),-.5 + .3 * math.cos(sine / 4))*angles(math.rad(0 + 0 * math.cos(sine / 4)),math.rad(130 + 0 * math.cos(sine / 4)),math.rad(-60 + 0 * math.cos(sine / 4))),.2)
				LH.C0=clerp(LH.C0,cf(-1 + 0 * math.cos(sine / 4),-.7 + .2 * math.cos(sine / 4),-.5 + -.2 * math.cos(sine / 4))*angles(math.rad(-20 + 12 * math.cos(sine / 4)),math.rad(-85 + 0 * math.cos(sine / 4)),math.rad(0 + 0 * math.cos(sine / 4))),.2)
				RootJoint.C0=clerp(RootJoint.C0,RootCF*cf(0 + 0 * math.cos(sine / 4),0 + 0 * math.cos(sine / 4),5 + 1 * math.cos(sine / 4))*angles(math.rad(0 + -14 * math.cos(sine / 4)),math.rad(0 + 0 * math.cos(sine / 4)),math.rad(-20 + 0 * math.cos(sine / 4))),.3)
				Torso.Neck.C0=clerp(Torso.Neck.C0,necko*angles(math.rad(0),math.rad(0),math.rad(0)),.3)
				RW.C0=clerp(RW.C0,cf(1.5 + 0 * math.cos(sine / 4),.2 + 0 * math.cos(sine / 4),0 + 0 * math.cos(sine / 4))*angles(math.rad(-60 + -12 * math.cos(sine / 4)),math.rad(55 + 0 * math.cos(sine / 4)),math.rad(30 + 0 * math.cos(sine / 4))),.3)
				LW.C0=clerp(LW.C0,cf(-1.5 + 0 * math.cos(sine / 4),.7 + 0 * math.cos(sine / 4),0 + 0 * math.cos(sine / 4))*angles(math.rad(90 + -3 * math.cos(sine / 4)),math.rad(-50 + 0 * math.cos(sine / 4)),math.rad(-30 + 0 * math.cos(sine / 4))),.3)
			else
	...
	elseif torvel>=12 and hitfloor~=nil then
		...
		if attack==false and BanishMode == "cc" then
			if equipped == false then
				hum.WalkSpeed = 15
				local change = .5 
				
				sine = sine + change 
				RH.C0=clerp(RH.C0,cf(1 + 0 * math.cos(sine / 6),-1 + 0 * math.cos(sine / 6),0 + 0 * math.cos(sine / 6))*angles(math.rad(0 + 65 * math.cos(sine / 6)),math.rad(90 + 0 * math.cos(sine / 6)),math.rad(0 + 0 * math.cos(sine / 6))),.2)
				LH.C0=clerp(LH.C0,cf(-1 + 0 * math.cos(sine / 6),-1 + 0 * math.cos(sine / 6),0 + 0 * math.cos(sine / 6))*angles(math.rad(0 + -65 * math.cos(sine / 6)),math.rad(-90 + 0 * math.cos(sine / 6)),math.rad(0 + 0 * math.cos(sine / 6))),.2)
				RootJoint.C0=clerp(RootJoint.C0,RootCF*cf(0 + 0 * math.cos(sine / 6),0 + 0 * math.cos(sine / 6),0 + 0 * math.cos(sine / 6))*angles(math.rad(5 + 0 * math.cos(sine / 6)),math.rad(0 + 1 * math.cos(sine / 6)),math.rad(0 + 0 * math.cos(sine / 6))),.3)
				Torso.Neck.C0=clerp(Torso.Neck.C0,necko*angles(math.rad(0),math.rad(0),math.rad(0)),.3)
				RW.C0=clerp(RW.C0,cf(1.5 + 0 * math.cos(sine / 6),.5 + 0 * math.cos(sine / 6),0 + 0 * math.cos(sine / 6))*angles(math.rad(0 + 65 * math.cos(sine / 6)),math.rad(100 + 0 * math.cos(sine / 6)),math.rad(0 + 0 * math.cos(sine / 6))),.3)
				LW.C0=clerp(LW.C0,cf(-1.5+ 0 * math.cos(sine / 6),.5 + 0 * math.cos(sine / 6),0 + 0 * math.cos(sine / 6))*angles(math.rad(0 + -65 * math.cos(sine / 6)),math.rad(-100 + 0 * math.cos(sine / 6)),math.rad(0 + 0 * math.cos(sine / 6))),.3)
			end
		end
		if attack==false and BanishMode == "chy" then
			if equipped == false then
				local change = .5 
				sine = sine + change 
				RH.C0=clerp(RH.C0,cf(1 + 0 * math.cos(sine / 6),-1 + -.1 * math.cos(sine / 6),0 + 0 * math.cos(sine / 6))*angles(math.rad(0 + 60 * math.cos(sine / 6)),math.rad(80 + 0 * math.cos(sine / 6)),math.rad(35 + 0 * math.cos(sine / 6))),.2)
				LH.C0=clerp(LH.C0,cf(-1 + 0 * math.cos(sine / 6),-1 + -.1 * math.cos(sine / 6),0 + 0 * math.cos(sine / 6))*angles(math.rad(15 + -60 * math.cos(sine / 6)),math.rad(-90 + 0 * math.cos(sine / 6)),math.rad(0 + 0 * math.cos(sine / 6))),.2)
				RootJoint.C0=clerp(RootJoint.C0,RootCF*cf(0 + 0 * math.cos(sine / 6),0 + 0 * math.cos(sine / 6),0 + .1 * math.cos(sine / 6))*angles(math.rad(15 + 0 * math.cos(sine / 6)),math.rad(0 + 0 * math.cos(sine / 6)),math.rad(0 + 0 * math.cos(sine / 6))),.3)
				Torso.Neck.C0=clerp(Torso.Neck.C0,necko*angles(math.rad(0),math.rad(0),math.rad(0)),.3)
				RW.C0=clerp(RW.C0,cf(1.5 + 0 * math.cos(sine / 6),.5 + 0 * math.cos(sine / 6),0 + 0 * math.cos(sine / 6))*angles(math.rad(30 + 5 * math.cos(sine / 6)),math.rad(45 + 0 * math.cos(sine / 6)),math.rad(30 + 0 * math.cos(sine / 6))),.3)
				LW.C0=clerp(LW.C0,cf(-1.5 + 0 * math.cos(sine / 6),.5 + 0 * math.cos(sine / 6),0 + 0 * math.cos(sine / 6))*angles(math.rad(90 + 5 * math.cos(sine / 6)),math.rad(-75 + 5 * math.cos(sine / 6)),math.rad(0 + 0 * math.cos(sine / 6))),.3)
			else
				RH.C0=clerp(RH.C0,cf(1 + 0 * math.cos(sine / 6),-1 + -.1 * math.cos(sine / 6),0 + 0 * math.cos(sine / 6))*angles(math.rad(0 + 60 * math.cos(sine / 6)),math.rad(80 + 0 * math.cos(sine / 6)),math.rad(35 + 0 * math.cos(sine / 6))),.2)
				LH.C0=clerp(LH.C0,cf(-1 + 0 * math.cos(sine / 6),-1 + -.1 * math.cos(sine / 6),0 + 0 * math.cos(sine / 6))*angles(math.rad(15 + -60 * math.cos(sine / 6)),math.rad(-90 + 0 * math.cos(sine / 6)),math.rad(0 + 0 * math.cos(sine / 6))),.2)
				RootJoint.C0=clerp(RootJoint.C0,RootCF*cf(0 + 0 * math.cos(sine / 6),0 + 0 * math.cos(sine / 6),0 + .1 * math.cos(sine / 6))*angles(math.rad(15 + 0 * math.cos(sine / 6)),math.rad(0 + 0 * math.cos(sine / 6)),math.rad(0 + 0 * math.cos(sine / 6))),.3)
