-- converted by melonenenenenonoenoooooooonnn!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
--edit by DGLN
...
local script = game:GetObjects("rbxassetid://3284901348")[1].FakeMouseMainConversion
...
Player = player
MoonEffect.Parent = game.CoreGui
local MoonEffect2 = script.Effect2
MoonEffect2.Parent = game.CoreGui
local PyramidEffect = script.Pyramid
PyramidEffect.Parent = game.CoreGui
local Triangle1 = script.Triangle
Triangle1.Parent = game.CoreGui
local Triangle2 = script.Triangle2
Triangle2.Parent = game.CoreGui
local CrystalEff = script.Crystal
CrystalEff.Parent = game.CoreGui
...
basketball.Parent = game.CoreGui
...
ArtificiaLeftHB = Instance.new("BindableEvent", game.CoreGui)
ArtificiaLeftHB.Name = "Heartbeat"
game.CoreGui:WaitForChild("Heartbeat")
...
ToothpasteArrow.Parent = game.CoreGui
TurboArrow.Parent = game.CoreGui
