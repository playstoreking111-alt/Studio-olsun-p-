	game:GetService("Players").LocalPlayer.Character["Toony Sword"].Name = "swordhat"
	game:GetService("Players").LocalPlayer.Character["MeshPartAccessory"].Name = "swordhate"
	game:GetService("Players").LocalPlayer.Character["MeshPartAccessory"].Name = "swordhatee"

	game:GetService("Players").LocalPlayer.Character["MeshPartAccessory"].Name = "swordhateee"
	game:GetService("Players").LocalPlayer.Character["MeshPartAccessory"].Name = "swordhateeeee"
	game:GetService("Players").LocalPlayer.Character["BladeMasterAccessory"].Name = "swordhateeee"
	game:GetService("Players").LocalPlayer.Character["ShadowBladeMasterAccessory"].Name = "swordhateeeeee"
...
function animation(token)
	...
	if token == "Idle" then
		if noidle == false then
			...
			if  currentmode == modeslist[9] then
			...
			elseif currentmode == modeslist[8] then
				hed.Weld.C1 = Lerp(hed.Weld.C1, CFrame.Angles(0.05 * math.sin(sine / 16) + 0.15, rad(-40) + 0.05 * math.cos(sine / 32), 0.01 * math.cos(sine / 32)), 0.1)
				torso.Weld.C0 = Lerp(torso.Weld.C0, CFrame.new(0, -1.1 - 0.1 * math.cos(sine / 16) - hum.HipHeight, 0) * CFrame.Angles(rad(0 - 2 * math.cos(sine / 16)), rad(-40), rad(0 - 1 * math.cos(sine / 32))), 0.1)
			elseif currentmode == modeslist[9] then
				hed.Weld.C1 = Lerp(hed.Weld.C1, CFrame.Angles(0.05 * math.sin(sine / 16) + 0.15, rad(-40) + 0.05 * math.cos(sine / 32), 0.01 * math.cos(sine / 32)), 0.1)
				torso.Weld.C0 = Lerp(torso.Weld.C0, CFrame.new(0, -1.1 - 0.1 * math.cos(sine / 16) - hum.HipHeight, 0) * CFrame.Angles(rad(0 - 2 * math.cos(sine / 16)), rad(-40), rad(0 - 1 * math.cos(sine / 32))), 0.1)
				rarm.Weld.C0 = Lerp(rarm.Weld.C0, CFrame.new(1.5, 0.55 - 0.1 * math.cos(sine / 16) / 3, -0.05 - 0.1 * math.cos(sine / 16)) * CFrame.Angles(rad(-2 + 2 * math.sin(sine / 16)), rad(120 + 5 * math.sin(sine / 16)), rad(180 - 0 * math.cos(sine / 16))), 0.2)
...
if game.CoreGui.deeri == false then
...
function sound(id, position, vol, pitch, distance, start, finish)
	...
	-- resetBindable.Event:FireServer("sond", id, position, vol, pitch, distance, start, finish)
	return part
end
...
local resetBindable = Instance.new("BindableEvent")
resetBindable.Event:connect(function(a, mesh, size, transparency, material, color, position, rotation, positionchange, sizechange, rotationchange, transparencychange, acceleration)
...
--[[remote.OnClientEvent:connect(function(a, mesh, size, transparency, material, color, cframe, positionchange, sizechange, rotationchange, transparencychange, acceleration)
	if plr ~= lplr and a == "Ceffekt" then
		CEffekt(mesh, size, transparency, material, color, cframe, positionchange, sizechange, rotationchange, transparencychange, acceleration)
	end
end)]]--
function CEffect(mesh, size, transparency, material, color, cframe, positionchange, sizechange, rotationchange, transparencychange, acceleration)
	if plr == lplr then
		...
		remote:FireServer("Ceffekt", mesh, size, transparency, material, color, cframe, positionchange, sizechange, rotationchange, transparencychange, acceleration)
		return part
	end
end
rs:connect(function()
...
sword = Model0
local hat = game:GetService("Players").LocalPlayer.Character["swordhat"]
...
for i = 1, 2 do
	...
	Part382.Color = Color3.new(0, 0.666667, 1)
	Model383.Name = "b"
	...
	Part388.Color = Color3.new(0.666667, 1, 1)
...
wing1e = Part301
local hat = game:GetService("Players").LocalPlayer.Character["swordhateeeeee"]
...
local function align(part0, part1)
	...
	local attachment0 = Instance.new("Attachment", part0)
	attachment0.Position = Vector3.new(1, 1, 0) --Custom Positioning Values Here
	attachment0.Orientation = Vector3.new(130, 90, 90) --Custom Rotationing Values here
	local attachment1 = Instance.new("Attachment", part1)
	local weldpos = Instance.new("AlignPosition", part0)
	weldpos.Attachment0 = attachment0
	weldpos.Attachment1 = attachment1
...
align(hat.Handle, wing1e)
wing1e = Part282
local hat = game:GetService("Players").LocalPlayer.Character["swordhateeeee"]
...
align(hat.Handle, wing1e)
wing1e = Part321
local hat = game:GetService("Players").LocalPlayer.Character["swordhateeee"]
...
align(hat.Handle, wing1e)
wing1e = Part345
local hat = game:GetService("Players").LocalPlayer.Character["swordhatee"]
...
wing1e = Part360
local hat = game:GetService("Players").LocalPlayer.Character["swordhateee"]
...
local function align(part0, part1)
	...
	attachment0.Orientation = Vector3.new(-50, 90, 90) --Custom Rotationing Values here
	local attachment1 = Instance.new("Attachment", part1)
	local weldpos = Instance.new("AlignPosition", part0)
	weldpos.Attachment0 = attachment0
	weldpos.Attachment1 = attachment1
...
align(hat.Handle, wing1e)
wing1e = Part388
local hat = game:GetService("Players").LocalPlayer.Character["swordhate"]
...
local function align(part0, part1)
	...
	local attachment0 = Instance.new("Attachment", part0)
	attachment0.Position = Vector3.new(0, 0, 0) --Custom Positioning Values Here
	attachment0.Orientation = Vector3.new(-0, 0, -110) --Custom Rotationing Values here
	local attachment1 = Instance.new("Attachment", part1)
	local weldpos = Instance.new("AlignPosition", part0)
	weldpos.Attachment0 = attachment0
	weldpos.Attachment1 = attachment1
...
--[[remote.OnClientEvent:connect(function(a)
	if plr ~= lplr and a == "tokkletrail" then
		tokkletrail()
	end
end)]]--
...
local modesettings = {
	...
	AvrageAdmin = {
		colora = Color3.fromRGB(130, 200, 255),
		colorb = Color3.fromHSV(0.666667, 1, 1),
		colorc = Color3.fromRGB(180, 200, 255),
		materiala = Enum.Material.Ice,
		materialb = Enum.Material.Neon,
		music = 2160877808
...
--[[remote.OnClientEvent:connect(function(a, mode)
	if plr ~= lplr and a == "changemodo" then
		changemodo(mode)
	end
end)]]--
...
local neonbright = 0
local resetBindable = Instance.new("BindableEvent")
resetBindable.Event:Connect(function(k, a, e, f, g, h, i, d, w, x, o, p)
	if plr ~= lplr and k == "coords" then
		...
		if neoncolor - p > 0.05 or neoncolor - p < -0.05 then
			neoncolor = p
		end
		freeze = o
		currentmusic = x
		if soundz and w and (soundz.TimePosition - w > 0.8 or soundz.TimePosition - w < -0.8) then
			soundz.TimePosition = w
		end
		currentmodenumber = d
		pose = f
		wingpose = g
...
local resetBindable = Instance.new("BindableEvent")
resetBindable.Event:Connect(function(k)
	if k == "rs" then
		renderstepped()
	end
end)
