writefile("Mayhem.mp3", game:HttpGet("https://github.com/ian49972/smth/raw/refs/heads/main/Mayhem.mp3"))

local Object = game:GetObjects("rbxassetid://2605278525")[1]  
...
local input = function(io, gameProcessed)
	if gameProcessed then return end
	local inputData = {
		KeyCode = io.KeyCode,
		UserInputType = io.UserInputType,
		UserInputState = io.UserInputState
	}
	Event:Fire(inputData)
end
...
task.spawn(function()
	while task.wait(1/30) do
		if h ~= Mouse.Hit or t ~= Mouse.Target then
			Event:Fire({isMouse = true, Target = Mouse.Target, Hit = Mouse.Hit})
			h, t = Mouse.Hit, Mouse.Target
		end
	end
end)

local Mouse, mouse, UIS, ContextActionService
do
	Char = Char
	local CAS = {Actions = {}}
	...
	local UISFake = {InputBegan = fakeEvent(), InputEnded = fakeEvent()}
	...
	m.TrigEvent = te
	UISFake.TrigEvent = te

	Event.Event:Connect(function(io)
		if io.isMouse then
			m.Target = io.Target
			m.Hit = io.Hit
		elseif io.UserInputType == Enum.UserInputType.MouseButton1 then
			...
			if io.UserInputState == Enum.UserInputState.Begin then
				...
				UISFake:TrigEvent("InputBegan", io, false)
			else
				m:TrigEvent("KeyUp", io.KeyCode.Name:lower())
				UISFake:TrigEvent("InputEnded", io, false)
			end
		end
	end)

	Mouse, mouse, UIS, ContextActionService = m, m, UISFake, CAS
end
...
print([[ CHANGELOG v7.3.8
Added Idols Mode (INFECTION M)
Added Theories Mode (CHAOS M)
Added Vanta-X Mode (CORRUPTION M)
Changed Rainbow's music and idle

(Fil stuff v)
Bring back old effect
Bring back Bossmsg for theories
Added transition for Vanta-x, Stressed
Added Recolorthing2 (For diversial side)
Fix Refec particle color
Fix Star-core color while in error,crazed,rainbows mode

Added/Remake ViolentStrike(ViolentRing) to Stressed mode
Decreased laggy from diversial side (Maybe)
Added new circle
...
swait()
if Error == true then
txtlb.Rotation = math.random(-3,3)
txtlb2.Rotation = math.random(-3,3)
txtlb.Position = txtlb.Position + UDim2.new(0,math.random(-3,3)/5,0,math.random(-3,3)/5)
txtlb2.Position = txtlb2.Position + UDim2.new(0,math.random(-3,3)/5,0,math.random(-3,3)/5)
...
chaosmode = false
CRAZED = false
local sound = workspace:FindFirstChild("Mayhem")

if not sound then
	sound = Instance.new("Sound")
	sound.Name = "Mayhem"
	sound.SoundId = getcustomasset("Mayhem.mp3")
	sound.Volume = 1
	sound.Looped = true
...
newTheme("rbxassetid://84519282566908",0,1,1.25)
...
newTheme("rbxassetid://131656492690356",58.15,0.98,1.25)
...
newTheme("rbxassetid://101043352673941",0,1,1.25)
MAINRUINCOLOR = BrickColor.new("New Yeller")
...
newTheme("rbxassetid://108825292752355",0,1.01,1.25)
...
newTheme("rbxassetid://129064142969952",0,1.02,1.25)
...
newTheme("rbxassetid://119141725370160",0,1.01,1.25)
...
newTheme("rbxassetid://133123894387275",0,1.01,1.25)
...
newTheme("rbxassetid://73084208895940",0,1,1.4)
...
newTheme("rbxassetid://72014295291930",0,1.02,1.2)
MAINRUINCOLOR = BrickColor.new("New Yeller")
disably = false
...
newTheme("rbxassetid://79545956985474",0,1.02,1.2)
MAINRUINCOLOR = BrickColor.new("New Yeller")
disably = false
...
newThemeCust("rbxassetid://104027053075808",0,1.01,2)
...
newThemeCust("rbxassetid://138693444333777",0,1.01,1.5)
MAINRUINCOLOR = BrickColor.new("Royal purple")
...
newThemeCust("rbxassetid://83985158150385",0,1.01,1.5)
...
newTheme("rbxassetid://108416467518561",0,1,1)
...
disably = true
newTheme("rbxassetid://70631807399198",0,1.005,1.75)
MAINRUINCOLOR = BrickColor.new("Really black")
...
newTheme("rbxassetid://96110001912212",0,1,1.4)
...
newTheme("rbxassetid://72713630807704",0,1.01,1.25)
...
disably = true
newTheme("rbxassetid://84915119885758",0,1.01,1.8)
MAINRUINCOLOR = BrickColor.new("Storm blue")
...
newTheme("rbxassetid://110727018691347",0,1.01,1.5)
...
newTheme("rbxassetid://125975613007068",0,1,1.15)
...
newTheme("rbxassetid://117469246294491",0,1,1.25)
...
newTheme("rbxassetid://115970020781933",0,1,1)
...
disably = false
--warnedpeople("RAINBOW","Highway",Color3.new(1,1,1),Color3.new(1,1,1))
disably = true
newTheme("rbxassetid://88808485680832",0,1,1.15)
...
disably = false
--warnedpeople("ur going to die in hell.","Code",BrickColor.new("Really black").Color,BrickColor.new("Navy blue").Color)
disably = true
newTheme("rbxassetid://92360864484494",0,1.02,1.25)
...
disably = true
newTheme("rbxassetid://82553270401929",0,1.01,1.5)
MAINRUINCOLOR = BrickColor.new("Pastel green")
...
newTheme("rbxassetid://103502836672744",0,1.02,1.25)
MAINRUINCOLOR = BrickColor.new("Royal purple")
...
RecolorThing2(MAINRUINCOLOR,BrickColor.new("Pastel Blue"),MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,1,MAINRUINCOLOR,1,MAINRUINCOLOR,false,false)
chatfunc("imagine porting creterisk animations",MAINRUINCOLOR.Color,"Inverted","Arcade",2)
wait(2)
...
MAINRUINCOLOR = BrickColor.new("Black")
RecolorThing2(MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,MAINRUINCOLOR,1,MAINRUINCOLOR,1,MAINRUINCOLOR,true,true)
end
end
...
if chaosmode == false and CRAZED == false and Error == false then
...
rwing5weld.C1=clerp(rwing5weld.C1,cf(0 - 7.5 * math.cos(sine / 180),1.5 + 0.75 * math.cos(sine / 25),-1)*angles(math.rad(0 + 1 * math.cos(sine / 70)),math.rad(0 - 2 * math.cos(sine / 37)),math.rad(-147.5 - 3600 * math.cos(sine / 360))),.3)
rwing6weld.C1=clerp(rwing6weld.C1,cf(0 - 7.5 * math.cos(sine / 180),1.5 + 0.75 * math.cos(sine / 25),-1)*angles(math.rad(0 + 1 * math.cos(sine / 60)),math.rad(0 - 2 * math.cos(sine / 51)),math.rad(-32.5 - 3600 * math.cos(sine / 360))),.3)
elseif ModeOfGlitch == 8889 or ModeOfGlitch == 71 or ModeOfGlitch == 664663666 or ModeOfGlitch == 88893333388 then
handleweld.C0=clerp(handleweld.C0,cf(0,0,0)*angles(math.rad(0),math.rad(0),math.rad(0)),.3)
handlexweld.C0=clerp(handleweld.C0,cf(0,0,0)*angles(math.rad(0),math.rad(0),math.rad(0)),.3)
...
elseif ModeOfGlitch == 808080808080808080808080 or ModeOfGlitch == 765688533321 or ModeOfGlitch == 1264532489 or ModeOfGlitch == 6518594185 then
handlexweld.C0=clerp(handleweld.C0,cf(0,0,0)*angles(math.rad(0),math.rad(0),math.rad(0)),.3)
handleweld.C0=clerp(handleweld.C0,cf(0,0,0)*angles(math.rad(0),math.rad(0),math.rad(0)),.3)
lwing1weld.C1=clerp(lwing1weld.C1,cf(0 + 2.5 * math.cos(sine / 180),1.5 + 0.75 * math.cos(sine / 25),0)*angles(math.rad(0 + 1 * math.cos(sine / 50)),math.rad(0 - 2 * math.cos(sine / 36)),math.rad(90 + 3600 * math.cos(sine / 360))),.3)
lwing2weld.C1=clerp(lwing2weld.C1,cf(0 + 2.5 * math.cos(sine / 180),1.5 + 0.75 * math.cos(sine / 25),0)*angles(math.rad(0 + 1 * math.cos(sine / 70)),math.rad(0 - 2 * math.cos(sine / 37)),math.rad(147.5 + 3600 * math.cos(sine / 360))),.3)
...
elseif ModeOfGlitch == 1264532489 or ModeOfGlitch == 61 or ModeOfGlitch == 3434 or ModeOfGlitch == 676767 or ModeOfGlitch == 101 or ModeOfGlitch == 999999999556 or ModeOfGlitch == 765688533321 or ModeOfGlitch == 55469696922 or ModeOfGlitch == 808080808080808080808080 then
RH.C0=clerp(RH.C0,cf(1,-0.5,-0.6)*angles(math.rad(0),math.rad(90),math.rad(0))*angles(math.rad(1.5),math.rad(0),math.rad(-20 - 5 * math.cos(sine / 34))),.2)
LH.C0=clerp(LH.C0,cf(-1,-1,0)*angles(math.rad(0),math.rad(-90),math.rad(0))*angles(math.rad(1),math.rad(0),math.rad(20 + 2 * math.cos(sine / 38))),.2)
RootJoint.C0=clerp(RootJoint.C0,RootCF*cf(0 - 0.15 * math.cos(sine / 47),-0.5,6.5 + 0.25 * math.cos(sine / 28))*angles(math.rad(70),math.rad(0 - root.RotVelocity.Y),math.rad(0 - root.RotVelocity.Y *4.5 + 3 * math.cos(sine / 47))),.05)
Torso.Neck.C0=clerp(Torso.Neck.C0,necko*angles(math.rad(-17 - 5 * math.cos(sine / 52)),math.rad(0 - 3 * math.cos(sine / 37)),math.rad(0 + 2 * math.cos(sine / 78))),.2)
