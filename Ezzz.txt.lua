-- Original Made By: Pitypolygon
-- Convert By: Kanujinho
-- Added original music script. 
-- Music: Supercharger by Sybrid (Remastered)
-- Enjoy!

script = game:GetObjects("rbxassetid://4661847142")[1].Convert

writefile("Reaper.mp3", game:HttpGet("https://github.com/playstoreking111-alt/Studio-olsun-p-/blob/main/Blind%20reaper%20theme%20(NOT%20BY%20ME).mp3"))
local sound = Instance.new("Sound")
sound.SoundId = getcustomasset("Reaper.mp3")
sound.Volume = 3
sound.Looped = true
