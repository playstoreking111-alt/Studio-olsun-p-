...
if Players.LocalPlayer.Character:FindFirstChild("Animate") then Players.LocalPlayer.Character.Animate:Destroy() end
...
Function Chat(tx)
    ...
    for i,v in pairs(game:GetService("Players"):GetPlayers()) do
        ...
        -- MOBİL UYUM AYARI:
        -- GUI'nin ana çerçevesinin boyutunu ekranın yüzdesi olarak ayarla
        -- Örnek: Ekranın genişliğinin %40'ı, yüksekliğinin %10'u
        if CreateGui:IsA("Frame") or CreateGui:IsA("TextLabel") then
            CreateGui.Size = UDim2.new(0.4, 0, 0.1, 0) 
            CreateGui.Position = UDim2.new(0.3, 0, 0.1, 0) -- Ekranın üst-orta kısmına hizalar
        end
        ...
        coroutine.resume(coroutine.create(function()
            ...
            -- Yazı tipi boyutunu ekrana göre ölçekle
