...
sound.SoundId = getcustomasset("Taste.mp3")
sound.Volume = 1
sound.Looped = true
...
local Players = game:GetService("Players")
local MaxDesignPro = Players.LocalPlayer

local Character = MaxDesignPro.Character or MaxDesignPro.CharacterAdded:Wait()
