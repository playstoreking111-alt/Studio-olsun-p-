...
--made by Makhail07
--FE code by Mokiros   
--Edited by XKxngSupremeX  and ozzak1003           --
...
BTAUNT3.SoundId = "http://www.roblox.com/asset/?id=2533880583"
BTAUNT3.Volume = 2
BTAUNT3.Pitch = 1
BTAUNT3.Looped = true
...
BC.HeadColor = BrickColor.new("Steel blue")
BC.LeftArmColor = BrickColor.new("Steel blue")
BC.LeftLegColor = BrickColor.new("Steel blue")
BC.RightArmColor = BrickColor.new("Steel blue")
BC.RightLegColor = BrickColor.new("Steel blue")
BC.TorsoColor = BrickColor.new("Steel blue")
...
tecks2.Parent = naeeym2
textfag = tecks2
tecks2.Text = "REEEEEEEEEEEEEE "
wait(2)
tecks2.Text = "DON'T U DARE LEAK DIS OR UR DED BOI"
wait(1)
tecks2.Text = "???"
BTAUNT:Play()
coroutine.resume(coroutine.create(function()
...
Fire.SoundId = "rbxassetid://2545211765"
Fire.Looped = true
Fire.Pitch = 1
Fire.Volume = 1
Fire:Play()
...
M2.TextureId = "rbxassetid://26884682"
        ...
        BC.HeadColor = BrickColor.new("Storm blue")
        BC.LeftArmColor = BrickColor.new("Storm blue")
        BC.LeftLegColor = BrickColor.new("Storm blue")
        BC.RightArmColor = BrickColor.new("Storm blue")
        BC.RightLegColor = BrickColor.new("Storm blue")
        BC.TorsoColor = BrickColor.new("Storm blue")
        tecks2:Remove()
        BTAUNT3:Play()
local naeeym2 = Instance.new("BillboardGui",char)
naeeym2.AlwaysOnTop = true
...
while true do
 ...
 if attack == false then
        rootj.C0 = clerp(rootj.C0, RootCF * CF(0, 0, 0.9), 0.2)
        neck.C0 = clerp(neck.C0, necko, 0.2)
        RH.C0 = clerp(RH.C0, RHCF, 0.2)
        LH.C0 = clerp(LH.C0, LHCF, 0.2)
        RW.C0 = clerp(RW.C0, CFrame.new(1.5, 0.5, 0), 0.2)
        LW.C0 = clerp(LW.C0, CFrame.new(-1.5, 0.5, 0), 0.2)
    end

    if Anim == "Idle" or Anim == "Walk" or Anim == "Sprint" then
        hum.PlatformStand = false
        hum.WalkSpeed = 16
    end

    if (Anim == "Jump" or Anim == "Fall") and hitfloor ~= nil then
        hum.PlatformStand = false
        hum.WalkSpeed = 16
        Anim = "Idle"
    end
