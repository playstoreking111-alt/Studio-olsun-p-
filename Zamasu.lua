...
writefile("Intro Zamasu.ogg", game:HttpGet("https://github.com/paravid/Music-Scripts/raw/refs/heads/main/Intro%20Zamasu.ogg"))
local zamasuintro = Instance.new("Sound")
zamasuintro.SoundId = getcustomasset("Intro Zamasu.ogg")
zamasuintro.Volume = 7
zamasuintro.Parent = game.Players.LocalPlayer.Character:WaitForChild("HumanoidRootPart")
zamasuintro:Play()
